...
<section class="bgg-pipeline" aria-labelledby="bgg-pipeline-title"><div class="bgg-pipeline__header"><span>Proceso de investigación</span><h3 id="bgg-pipeline-title">Del texto de las reseñas a evidencia estructurada</h3><p>Cada etapa reutiliza los datos, decisiones y artefactos validados en la anterior.</p></div><ol><li><span>01</span><div><strong>Corpus</strong><p>Adquisición, limpieza, idioma y anotación con trazabilidad.</p></div></li><li><span>02</span><div><strong>Modelos dispersos</strong><p>TF-IDF, señales de opinión y benchmarks clásicos controlados.</p></div></li><li><span>03</span><div><strong>Secuencia</strong><p>FastText, FNN y LSTM para medir el valor del orden de las palabras.</p></div></li><li><span>04</span><div><strong>Contexto</strong><p>Fine-tuning de BERT con significado condicionado a la reseña completa.</p></div></li><li><span>05</span><div><strong>Explicación</strong><p>Aspectos, polaridad y evidencia anclados al lenguaje original.</p></div></li></ol></section>
...
<div class="bgg-chart-grid"><figure class="bgg-chart" data-bgg-chart="classic"><div class="bgg-chart__header"><div><span>Benchmark P2</span><h4>Modelos clásicos</h4><p>Macro-F1 en el test balanceado compartido de P2</p></div><strong>Mejor: 0.7309</strong></div><div class="bgg-chart__canvas"><canvas role="img" aria-label="Macro-F1 de Linear SVM, Naive Bayes, XGBoost y Random forest"></canvas></div><figcaption>Comparación controlada: mismas particiones del corpus y mismas etiquetas.</figcaption></figure><figure class="bgg-chart" data-bgg-chart="neural"><div class="bgg-chart__header"><div><span>Registro P3</span><h4>Modelos neuronales y contextuales</h4><p>Macro-F1 en las configuraciones documentadas de P3</p></div><strong>Mejor: 0.8432</strong></div><div class="bgg-chart__canvas"><canvas role="img" aria-label="Macro-F1 de BERT, FastText LSTM y FastText FNN"></canvas></div><figcaption>BERT usó un corpus aparte de ~60k reseñas y texto crudo; FNN y LSTM comparten embeddings estáticos.</figcaption></figure></div>
