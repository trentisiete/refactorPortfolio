...
<div class="bgg-chart-grid"><figure class="bgg-chart" data-bgg-chart="classic"><div class="bgg-chart__header"><div><span>Benchmark P2</span><h4>Modelos clásicos</h4><p>Test balanceado compartido</p></div><strong>Mejor: 0.7309</strong></div><div class="bgg-chart__canvas"><canvas role="img" aria-label="Macro-F1 de SVM lineal, Naive Bayes, XGBoost y Random Forest"></canvas></div><figcaption>Mismas particiones del corpus y mismas etiquetas.</figcaption></figure><figure class="bgg-chart" data-bgg-chart="neural"><div class="bgg-chart__header"><div><span>Registro P3</span><h4>Modelos neuronales y contextuales</h4><p>Configuraciones experimentales documentadas</p></div><strong>Mejor: 0.8432</strong></div><div class="bgg-chart__canvas"><canvas role="img" aria-label="Macro-F1 de BERT, FastText con LSTM y FastText con red feedforward"></canvas></div><figcaption>BERT usa un corpus separado; FNN y LSTM comparten embeddings estáticos.</figcaption></figure></div>
