    ...
    gallery: [
      {
        ...
        alt: 'Evolution of a Gaussian process during Forrester optimization',
        caption: 'How the Gaussian process evolves as new evaluations are incorporated.',
      },
      {
        src: '/assets/articles/surrogate_models/fig_05_uncertainty_vs_error.png',
        alt: 'Relationship between predictive uncertainty and surrogate-model error',
        caption: 'Diagnostic relationship between uncertainty and predictive error.',
      },
      {
        src: '/assets/articles/surrogate_models/fig_08_ei_candidate_landscape.png',
        alt: 'Candidate landscape according to Expected Improvement',
        caption: 'Prioritization of new candidates using Expected Improvement.',
      },
    ],
  },
  {
    ...
    gallery: [
      {
        ...
        alt: 'Road-damage detection in an image from China',
        caption: 'Inference example for road damage in the China domain.',
      },
      {
        src: '/assets/articles/roadguard/example_4_United_States.jpg',
        alt: 'Road-damage detection in an image from the United States',
        caption: 'Transfer of the system to the United States domain.',
      },
      {
        src: '/assets/articles/roadguard/stress_robustness.png',
        alt: 'RoadGuard robustness results under visual degradation',
        caption: 'Stress test under darkness and blur.',
      },
    ],
  },
  {
    ...
    gallery: [
      {
        ...
        alt: 'Evolution from noise to images generated by a diffusion model',
        caption: 'From initial noise to the final sample using a VP-SDE.',
      },
      {
        src: '/assets/articles/difussion_models/comparativa_samplers_vp_lineal.png',
        alt: 'Visual comparison of different diffusion samplers',
        caption: 'Comparison of results across four sampling strategies.',
      },
      {
        src: '/assets/articles/difussion_models/imputacion_cifar_mnist_3etapas.png',
        alt: 'Region imputation in CIFAR-10 images',
        caption: 'Reconstruction of masked regions using diffusion.',
      },
    ],
  },
];
