...
async function translateProfileFile(apiKey, raw, sourceLang, targetLang, previous) {
	...
	const system = [
		...
		'- Translate ONLY human-visible string values: title, intro, tabsLabel, section labels, job titles, locations, details, link labels, image alt texts, excerpts, and gallery caption VALUES.',
		'- Object KEYS are never translated, especially image filename keys in caption maps (e.g. { \'fig_01.png\': \'...\' }): the key stays byte-identical, only its value is translated.',
